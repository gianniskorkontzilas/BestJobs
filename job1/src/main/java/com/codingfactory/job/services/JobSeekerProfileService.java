...
import com.codingfactory.job.repository.JobSeekerProfileRepository;
import com.codingfactory.job.repository.UsersRepository;
import com.codingfactory.job.services.exceptions.SeekerAlreadyExistsException;
...
public class JobSeekerProfileService {
    ...
    public Optional<JobSeekerProfile> getOne(Integer id) throws Exception {
        return jobSeekerProfileRepository.findById(id);
    }

    public JobSeekerProfile addNew(JobSeekerProfile jobSeekerProfile)  throws SeekerAlreadyExistsException {
        return jobSeekerProfileRepository.save(jobSeekerProfile);
    }

    public JobSeekerProfile getCurrentSeekerProfile() throws Exception{
