...
public class UsersService {
    ...
    @Autowired
    public UsersService(UsersRepository usersRepository, JobSeekerProfileRepository jobSeekerProfileRepository, RecruiterRepository recruiterRepository, PasswordEncoder passwordEncoder) {
