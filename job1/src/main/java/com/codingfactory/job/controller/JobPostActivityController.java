...
import com.codingfactory.job.dto.RecruiterJobsDto;
import com.codingfactory.job.services.JobPostActivityService;
import com.codingfactory.job.services.SeekerApplyService;
...
public class JobPostActivityController {
    ...
    @Autowired
    public JobPostActivityController(UsersService usersService, JobPostActivityService jobPostActivityService, SeekerApplyService seekerApplyService, SeekerSaveService seekerSaveService) {
    ...
    public String searchJobs(Model model,
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            if (authentication.getAuthorities().contains(new SimpleGrantedAuthority("Recruiter"))) {
                List<RecruiterJobsDto> recruiterJobs = jobPostActivityService.getRecruiterJobs(((Recruiter) currentUserProfile).getUserAccountId());
                model.addAttribute("jobPost", recruiterJobs);
            } else {
                List<SeekerApply> seekerApplyList = seekerApplyService.getCandidatesJobs((JobSeekerProfile) currentUserProfile);
                ...
                for (JobPostActivity jobActivity : jobPost) {
                    ...
                    for (SeekerApply seekerApply : seekerApplyList) {
                        if (Objects.equals(jobActivity.getJobPostId(), seekerApply.getJob().getJobPostId())) {
                    ...
                    for (SeekerSave seekerSave : seekerSaveList) {
                        if (Objects.equals(jobActivity.getJobPostId(), seekerSave.getJob().getJobPostId())) {
